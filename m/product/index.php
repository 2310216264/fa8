...
<div class="sertj box" id="sertj1" style="display:none;">
 ...
 <? while2("*","yjcode_type where admin=2 and type1='".$ty1name."' order by xh asc");while($row2=mysqli_fetch_array($res2)){?>
...
<? 
pagef($ses,10,"yjcode_pro",$px);while($row=mysqli_fetch_array($res)){
