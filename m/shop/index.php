...
<?
pagef($ses,20,"yjcode_user",$px);while($row=mysqli_fetch_array($res)){
$au="view".$row[id].".html";
?>
...
<div class="dmain">
 <?
 while2("*","yjcode_pro where userid=".$row[id]." and zt=0 and ifxj=0 order by lastsj desc limit 3");while($row2=mysqli_fetch_array($res2)){
