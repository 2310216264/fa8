...
<div class="indextop1 box">
 ...
 <div class="d3"><?=returncount("yjcode_pro where userid=".$rowuser[id]." and zt=0 and ifxj=0")?><br>宝贝</div>
 <div class="d3"><?=returncount("yjcode_server where userid=".$rowuser[id]." and zt=0 and ifxj=0")?><br>服务</div>
 <div class="d4"><?=$rowuser[djl]?><br>关注</div>
</div>
...
<div class="d1">
 ...
 <a href="prolist_i<?=$uid?>v.html" id="topmenu2">商品</a>
 <a href="serverlist_i<?=$uid?>v.html" id="topmenu5">服务</a>
