...
<? $i=1;while1("*","yjcode_type where admin=1 and id<>3 order by xh asc");while($row1=mysqli_fetch_array($res1)){?>
...
<div class="pright" id="pright<?=$i?>" style="display:none;">
 <? while2("*","yjcode_type where admin=2 and type1='".$row1[type1]."' order by xh asc");while($row2=mysqli_fetch_array($res2)){?>
