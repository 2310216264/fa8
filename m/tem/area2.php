...
$area3id=intval($_GET[area3id]);
if($area1id!=""){$ses1=" and parentid='".$area1id."'";}else{$ses1=" and id=0";}
...
<div class="shdzt1 box">
 ...
 <div class="d2">
  ...
  <? while3("*","yjcode_city where level=1 order by xh asc");while($row3=mysqli_fetch_array($res3)){?>
...
<div class="shdz box">
 ...
 <div class="d2">
  ...
  <? while1("*","yjcode_city where level=2".$ses1." order by xh asc");while($row1=mysqli_fetch_array($res1)){?>
...
<div class="shdz box">
 ...
 <div class="d2">
  ...
  <? while2("*","yjcode_city where level=3".$ses2." order by xh asc");while($row2=mysqli_fetch_array($res2)){?>
