...
<link href="css/global.css?t=<?=$glosxbh?>" rel="stylesheet" type="text/css" />
<link href="css/basic.css?t=<?=$glosxbh?>" rel="stylesheet" type="text/css" />
<link href="css/index.css?t=<?=$glosxbh?>" rel="stylesheet" type="text/css" />
<script language="javascript" src="js/global.js?t=<?=$glosxbh?>"></script>
<script language="javascript" src="js/basic.js?t=<?=$glosxbh?>"></script>
<script language="javascript" src="js/jquery-1.9.1.min.js?t=<?=$glosxbh?>"></script>
<script language="javascript" src="js/layer.js?t=<?=$glosxbh?>"></script>
<script language="javascript" src="js/index.js?t=<?=$glosxbh?>"></script>
</head>
<body>
<div class="yjcode">
