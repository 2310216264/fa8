...
$sqltaskhf="select * from yjcode_taskhf where bh='".$bh."' and useridhf=".$useridhf." and taskty=1 and zt=0 and id=".$hfid."";mysqli_set_charset($conn,"utf8");$restaskhf=mysqli_query($conn,$sqltaskhf);
if(!$rowtaskhf=mysqli_fetch_array($restaskhf)){php_toheader("taskhflist1.php");}

$sqltask="select * from yjcode_task where bh='".$bh."' and taskty=1";mysqli_set_charset($conn,"utf8");$restask=mysqli_query($conn,$sqltask);
if(!$rowtask=mysqli_fetch_array($restask)){php_toheader("taskhflist1.php");}
