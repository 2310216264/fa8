...
if(sqlzhuru($_POST[yjcode])=="jf"){
 ...
 if(empty($txt)){Audit_alert("申请理由内容不得为空，返回重试！","serverorderjf2.php?orderbh=".$orderbh);}
 intotable("yjcode_serverorderlog","orderbh,userid,selluserid,admin,txt,sj","'".$orderbh."',".$row[userid].",".$row[selluserid].",2,'".$txt."','".$sj."'");
 php_toheader("serverorderjf2.php?orderbh=".$orderbh); 
...
<div class="bfbtop1 box">
 <div class="d1" onClick="gourl('sellserverorderview.php?orderbh=<?=$orderbh?>')"><img src="img/topleft.png" height="21" /></div>
...
f1.action="serverorderjf2.php?orderbh=<?=$orderbh?>";
}
</script>
