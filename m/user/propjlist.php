...
<div class="dmain flex">
 <?
 $ses=" where admin=2 and ifpj=1 and selluserid=".$rowuser[id];
 ...
 <ul class="u1">
 <li class="l1">商品信息</li>
 <li class="l2"><strong class="lineone"><a href="../product/view<?=$row1[id]?>.html" target="_blank"><?=$row1[tit]?></a></strong></li>
 <li class="l1">评价会员</li>
 ...
 <ul class="u2">
 <li class="l1">回复内容</li>
 <li class="l2" style="cursor:pointer;" onClick="gourl('propjhf.php?id=<?=$row[id]?>')"><? if(empty($row[hftxt])){?><span class="hui">【暂未回复，点击进行回复】</span><? }else{?><span class="green">回复时间：<?=$row[hfsj]?><br>回复内容：<?=$row[hftxt]?></span><? }?></li>
 </ul>
 <? }?>
</div>
</div>
