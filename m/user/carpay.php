...
function carpaytj(x){
 ...
 if(rv=="alipay" || rv==""){
  ...
  if(ua.match(/MicroMessenger/i) == 'micromessenger'){
  fu="wxpay1/carpay.php?carid="+x;
  }else{
  fu="wxpay/buy_index.php?carid="+x;
  }
  //小程序B
  wx.miniProgram.getEnv(function(res) { 
  if(res.miniprogram){
   fu="wxpay1/carpay.php?wxly=1&carid="+x;
  }
  })
  //小程序E
  
 }
 else if(rv=="aliewm"){f1.action="alipay_ewm.php?money1=<?=$needmoney?>";}
 else if(rv=="wxewm"){f1.action="wxpay_ewm.php?money1=<?=$needmoney?>";}
...
<div class="bfbtop1 box">
 ...
 <div class="d3"></div>
  ...
  <div class="pay box">
   ...
   <? if( (!empty($rowcontrol[seller_email]) || (!empty($rowcontrol[alipaywap]) && $rowcontrol[alipaywap]!=",,")) && 3!=$rowcontrol[zftype]){?>
   ...
   <li class="l2">
   <input name="R1" id="aliewm" type="radio" value="aliewm" /><img onClick="xz('aliewm')" src="../../user/img/pay/alipay.gif" />
   </li>
   <? }?>
   ...
   <li class="l2">
   <input name="R1" id="wxewm" type="radio" value="wxewm" /><img src="../../user/img/pay/wxpay.gif" onClick="xz('wxewm')" />
   </li>
   <? }?> 
