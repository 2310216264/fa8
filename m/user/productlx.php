...
<div class="fbbtn box">
 ...
 while0("*","yjcode_pro where id=".$_GET[id]."");if(!$row=mysqli_fetch_array($res)){php_toheader("productlist.php");}
 ?>
...
<div class="uk box">
 ...
 <select name="d1" id="d1" style="font-size:13px;" onChange="typeonc()">
 <option value="">点击选择一级分类</option>
 <? while1("*","yjcode_type where admin=1 id<>3 order by xh asc");while($row1=mysqli_fetch_array($res1)){?>
