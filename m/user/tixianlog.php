...
if($_GET[e]=="back"){
 $id=intval($_GET[id]);
 while0("*","yjcode_tixian where id=".$id." and userid=".$userid." and zt=4");if($row=mysqli_fetch_array($res)){
...
<div class="bfbtop1 box">
 ...
 pagef($ses,30,"yjcode_tixian","order by sj desc");while($row=mysqli_fetch_array($res)){
 $cz="";
