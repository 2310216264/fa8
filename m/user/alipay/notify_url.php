...
$userid=$dingdanbh[1];
$sql="select * from yjcode_dingdang where ddbh='".$out_trade_no."' and ifok=0 and userid=".$userid;mysqli_set_charset($conn,"utf8");$res=mysqli_query($conn,$sql);
if($row=mysqli_fetch_array($res)){
 if(1==$row[ifok]){echo "success";exit;}
 if(round($_POST["buyer_pay_amount"],2)!=round($row["money1"],2)){echo "success";exit;}
