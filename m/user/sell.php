...
<div class="selltop1 box">
 <div class="dmain flex">
  ...
  <div class="d2"><strong><?=sprintf("%.2f",$rowuser[money1])?></strong><br>可用余额</div><span class="x"></span>
  <div class="d2 d3" onClick="gourl('zzrz.php')"><strong><?=returnzzrzzt($rowuser[zzrz])?></strong><br>执照认证</div>
 </div>
</div>
...
<div class="dmain flex">
 ...
 <? $a=returncount("yjcode_order where selluserid=".$rowuser[id]." and ddzt='back' and admin=1");?>
 <li<? if($a>0){?> class="l1"<? }?> onClick="gourl('sellorder.php?ddzt=back')"><span class="s1">退款申请中</span><span class="s2"><?=$a?>笔</span></li>
 <? $a=returncount("yjcode_order where selluserid=".$rowuser[id]." and ddzt='jf' and admin=1");?>
 <li<? if($a>0){?> class="l1"<? }?> onClick="gourl('sellorder.php?ddzt=jf')"><span class="s1">纠纷处理</span><span class="s2"><?=$a?>笔</span></li>
 <? $a=returncount("yjcode_order where selluserid=".$rowuser[id]." and ddzt='db' and admin=1");?>
 <li onClick="gourl('sellorder.php?ddzt=db')"><span class="s1">正在担保</span><span class="s2"><?=$a?>笔</span></li>
 <? $a=returncount("yjcode_order where selluserid=".$rowuser[id]." and ddzt='backerr' and admin=1");?>
 <li onClick="gourl('sellorder.php?ddzt=backerr')"><span class="s1">不同意退款</span><span class="s2"><?=$a?>笔</span></li>
 <? $a=returncount("yjcode_order where selluserid=".$rowuser[id]." and ddzt='suc' and admin=1");?>
...
<div class="dmain flex">
 ...
 <ul class="u1">
 <? $a=returncount("yjcode_order where ifpj=1 and selluserid=".$rowuser[id]." and (hftxt='' or hftxt is null) and admin=2");?>
 <li<? if($a>0){?> class="l1"<? }?> onClick="gourl('propjlist.php?ifhf=no')"><span class="s1">需要回复</span><span class="s2"><?=$a?>条</span></li>
 <? $a=returncount("yjcode_order where ifpj=1 and admin=2 and selluserid=".$rowuser[id]);?>
