...
<div class="uk box">
 ...
 <? while1("*","yjcode_protype where admin=1 and zt=0 and userid=".$rowuser[id]);while($row1=mysqli_fetch_array($res1)){?>
 ...
 <? while2("*","yjcode_protype where admin=2 and name1='".$row1[name1]."' and zt=0 and userid=".$rowuser[id]);while($row2=mysqli_fetch_array($res2)){?>
