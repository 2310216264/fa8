...
$mybh=returnsx("c");
$pwd=returnsx("d");
$sqluser="select uid,pwd,mybh from yjcode_user where mybh='".$mybh."' and pwd='".$pwd."'";mysqli_set_charset($conn,"utf8");$resuser=mysqli_query($conn,$sqluser);
if(!$rowuser=mysqli_fetch_array($resuser)){echo weburl."m/";exit;}
