...
<? }?>
<div class="ordermain2 box"><div class="d1">商家信息:</div><div class="d2"><?=$rowsell[shopname]?></div></div>
<div class="ordersell1 box"><div class="d1">商家QQ:</div><div class="d2"><span onclick="qqtang('<?=$rowsell[uqq]?>')"><?=$rowsell[uqq]?></span></div></div>
<div class="ordersell1 box"><div class="d1">商家微信:</div><div class="d2"><?=$rowsell[weixin]?></div></div>
...
<div class="jflist box">
 <div class="jfgtlist">
  <? 
  $i=1;
  while1("*","yjcode_orderlog where zuorderbh='".$zuorderbh."' and userid=".$userid." order by sj desc");while($row1=mysqli_fetch_array($res1)){
  $txt=$row1[txt];
