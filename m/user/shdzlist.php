...
$sj=date("Y-m-d H:i:s");
if($_GET[control]=="del"){
deletetable("yjcode_shdz where userid=".$userid." and id=".intval($_GET[id]));
...
pagef(" where zt=0 and userid=".$userid,10,"yjcode_shdz","order by sj desc");while($row=mysqli_fetch_array($res)){
