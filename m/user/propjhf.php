...
while0("*","yjcode_order where selluserid=".$userid." and id=".$id);if(!$row=mysqli_fetch_array($res)){Audit_alert("来源错误","propjlist.php");}

if($_GET[control]=="update"){
 zwzr();
 updatetable("yjcode_order","hftxt='".sqlzhuru($_POST[s1])."',hfsj='".$sj."' where selluserid=".$userid." and id=".$id);
...
<div class="uk box">
 ...
 <div class="d21"><?=$row[pjtxt]?></div>
</div>
<div class="uk box">
 <div class="d1">回复内容<span class="s1"></span></div>
 <div class="d2"><textarea name="s1" placeholder="请输入回复内容"><?=$row[hftxt]?></textarea></div>
</div>
