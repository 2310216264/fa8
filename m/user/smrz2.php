...
$rowuser=mysqli_fetch_array($resuser);if($rowuser[sfzrz]!=2 && $rowuser[sfzrz]!=3){php_toheader("smrz.php"); }
...
if($_POST[jvs]=="smrz"){
 ...
 $uname=$rowuser[uname];
 $sfz=$rowuser[sfz];
 $sfztp1="../../upload/".$rowuser[id]."/".strgb2312($sfz,0,15)."-1.jpg";
 include("../../tem/autosfz.php");
