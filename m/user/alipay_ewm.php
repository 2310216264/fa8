...
function tj(){
 ...
 if(document.f1.t2.value==""){layerts("请输入扫码支付成功后的支付宝订单号");return false;}
...
<div class="d21"><img src="../../img/alipay_ewm.jpg" width="150" height="150" /></div>
</div>

<div class="uk box">
 <div class="d1">操作提示</div>
 <div class="d21">请打开手机支付宝，扫描以上二维码充值转账</div>
</div>
...
<div class="uk box">
 ...
 <div class="d2"><input type="text" name="t2" class="inp" style="font-weight:700;color:#ff6600;" placeholder="请输入扫码支付成功后的支付宝订单号" /></div>
</div>
