...
function qqtang(x,y,z){
str="<div class='qqtang'><span class='qqtang1'>QQ:<strong id='qq_element'>"+x+"</strong></span>";
str=str+"<span class='qqtang2'><a href='mqqwpa://im/chat?chat_type=wpa&uin="+x+"&version=1&src_type=web' target='_blank'>直接对话</a></span>";
str=str+"<span class='qqtang2' onClick=\"copyToClipboard('qq_element')\">复制QQ</span>";
if(y!="" && y!=undefined){
str=str+"<div class='clear'></div><span class='wxtang1'>微信：<strong id='wx_element'>"+y+"</strong></span>";
str=str+"<span class='wxtang2' onClick=\"copyToClipboard('wx_element')\">复制微信</span>";
str=str+"<div class='clear'></div><span class='wxtang3'><img src='/upload/"+z+"/wx.jpg' /></span>";
}
str=str+"<div class='clear'></div><span class='qqtang4'>声明：该QQ号是用户提供，平台不确保其真实性，涉及资金交易时，请核实所要购买的商品与该QQ号是否有关联（谨防QQ无效、冒用等情况）</span></div>";
layer.open({
    content: str
  });
}
