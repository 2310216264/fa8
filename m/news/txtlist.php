...
if($row1=mysqli_fetch_array($res1)){$pre="<a href='txtlist_i".$row1[id]."v.html' class='a1'>上一篇</a>";}
...
if($row1=mysqli_fetch_array($res1)){$nex="<a href='txtlist_i".$row1[id]."v.html' class='a2'>下一篇</a>";}
...
<? 
$wxfxtit=$row[tit];
$wxfxurl=weburl."m/news/txtlist_i".$id."v.html";
