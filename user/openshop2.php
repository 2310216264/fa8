...
if($_POST[jvs]=="openshop"){
 ...
 while1("*","yjcode_openyue where id=".$d[2]);if(!$row1=mysqli_fetch_array($res1)){Audit_alert("操作失败，返回重试！","openshop2.php");}
...
<div class="userright">
 ...
 <? 
 while1("*","yjcode_openyue order by yue asc");while($row1=mysqli_fetch_array($res1)){
