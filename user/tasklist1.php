...
<div class="userright">
 ...
 <div class="ksedi">
 <div class="d1">
 <a href="javascript:NcheckDEL(4,'yjcode_task')" class="a1">删除</a>
 ...
 ?>
 <ul class="tasklist">
 <li class="l0"><? if($row[zt]==100 || $row[zt]==102 || $row[zt]==103|| $row[zt]==105 || $row[zt]==106){?><input name="C1" type="checkbox" value="<?=$row[bh]?>" /><? }?></li>
 <li class="l1">
