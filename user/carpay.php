...
<div class="userright">
 ...
 <div class="carpay">
  ...
  <li class="l2">
  <input name="R1" id="aliewm" type="radio" value="aliewm" /><img onClick="xz('aliewm')" src="img/pay/alipay.gif" />
  </li>
  <? }?>
  ...
  <li class="l2">
  <input name="R1" id="wxewm" type="radio" value="wxewm" /><img src="img/pay/wxpay.gif" onClick="xz('wxewm')" />
  </li>
  <? }?>
