...
if(!$rowuser=mysqli_fetch_array($resuser)){Audit_alert("来源错误","openshop3.php","parent.");}
$userid=$rowuser[id];
while0("*","yjcode_shopmenu where userid=".$userid." and bh='".$bh."' and admin=2");if(!$row=mysqli_fetch_array($res)){Audit_alert("来源错误","shopmenulist.php","parent.");}
...
if($_GET[control]=="update"){
 ...
 updatetable("yjcode_shopmenu","tit2='".sqlzhuru($_POST[ttit2])."',aurl='".sqlzhuru($_POST[taurl])."',xh=".intval($_POST[txh]).",targ=".intval($_POST[R1]).",zt=0 where userid=".$userid." and id=".$row[id]);
