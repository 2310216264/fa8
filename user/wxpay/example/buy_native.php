...
$sql="select * from yjcode_dingdang where ddbh='".$ddbh."'";mysqli_set_charset($conn,"utf8");$res=mysqli_query($conn,$sql);
if(!$row=mysqli_fetch_array($res)){php_toheader("../../car.php");exit;}
if(1==$row[ifok]){php_toheader("../../order.php");}
function updatetable($utable,$ures,$uwhere=""){global $conn;$sqlupdate="update ".$utable." set ".$ures." ".$uwhere;mysqli_set_charset($conn,"utf8");mysqli_query($conn,$sqlupdate);}
