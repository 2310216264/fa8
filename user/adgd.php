...
$bh=$_GET[bh];
$sj=date("Y-m-d H:i:s");
while0("*","yjcode_adlx where bh='".$bh."' and fflx=1 and admin=1");if(!$row=mysqli_fetch_array($res)){php_toheader("adlx1.php");}
...
<div class="userright">
 ...
 <? while1("*","yjcode_adlx where admin=2 and bh='".$bh."' order by id asc");while($row1=mysqli_fetch_array($res1)){?>
