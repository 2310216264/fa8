...
<div class="userright">
<ul class="wz">
<li class="l1 l2"><a href="productlist.php">商品列表</a></li>
</ul> 
...
<?
pagef($ses,10,"yjcode_pro","order by lastsj desc");while($row=mysqli_fetch_array($res)){
...
<? if(1==$row[touchy]){?><div style="float:right;color:red;padding-right:4%;">内容是否敏感：敏感</div><? }?>
