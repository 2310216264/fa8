...
$userid=$rowuser[id];
while0("*","yjcode_provideo where bh='".$mybh."' and probh='".$bh."' and userid=".$userid);if(!$row=mysqli_fetch_array($res)){php_toheader("provideolist.php?bh=".$bh);}
...
if($_GET[control]=="update"){
 ...
 updatetable("yjcode_provideo","tit='".sqlzhuru($_POST[ttit])."'".$ses.",iftj=".$iftj.",admin=".intval($_POST[d1]).",zt=".$nzt.",gs='".sqlzhuru($_POST[d2])."' where id=".$row[id]);
