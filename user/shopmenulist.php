...
<div class="userright">
 ...
 <? while1("*","yjcode_shopmenu where userid=".$luserid." and admin=1 and zt=0 order by xh asc");while($row1=mysqli_fetch_array($res1)){?>
 ...
 <? while2("*","yjcode_shopmenu where userid=".$luserid." and admin=2 and zt=0 and tit1='".$row1[tit1]."' order by xh asc");while($row2=mysqli_fetch_array($res2)){?>
