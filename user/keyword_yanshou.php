...
<ul class="wz">
<li class="l1 l2"><a href="javascript:;">验收</a></li>
...
<li class="l4" style="height:400px;">请求验收：</li>
...
<li class="l1">进行验收：</li>
<li class="l2">
<label><input name="zt" type="radio" value="5"/> <strong>确认验收</strong></label>
<label><input name="zt" type="radio" value="6"/> <strong>不满意</strong></label> 
</li>
...
function yanshou(){
    ...
    $.ajax({
        ...
        data: {id:id,zt:rr,yjcode_keyorder:'yanshou'},
	    dataType: "json", 
