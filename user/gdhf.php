...
$bh=$_GET[bh];
while0("*","yjcode_gd where userid=".$userid." and bh='".$bh."'");if(!$row=mysqli_fetch_array($res)){php_toheader("gdlist.php");}
...
<div class="userright">
 ...
 <div class="gdhflist">
  ...
  <? 
  while1("*","yjcode_gdhf where gdbh='".$bh."' and zt=0 order by sj asc");while($row1=mysqli_fetch_array($res1)){
  $txt=$row1[txt];
