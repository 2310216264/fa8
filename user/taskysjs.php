...
$sqltask="select * from yjcode_task where bh='".$bh."' and taskty=0 and zt=3 and useridhf=".$useridhf."";mysqli_set_charset($conn,"utf8");$restask=mysqli_query($conn,$sqltask);
...
<div class="userright">
 ...
 <? include("taskv.php");?>
 <? 
 while1("*","yjcode_taskhf where bh='".$bh."' and ifxz=1");if($row1=mysqli_fetch_array($res1)){
