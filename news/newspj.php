...
while0("id,bh,userid","yjcode_news where bh='".$bh."'");if(!$row=mysqli_fetch_array($res)){Audit_alert("信息不存在！","./");}
...
while1("*","yjcode_newspj where newsbh='".$bh."' and userid=".$userid." order by sj desc");if($row1=mysqli_fetch_array($res1)){
