...
(22, '1416211155ad4', '文字', '', '新闻资讯', 'ADI02', '', '2014-11-17 15:59:15', '/news/', NULL, 2, 0, 0, '2049-12-12 12:12:12', 0, NULL, NULL),
(23, '1416211172ad39', '文字', '', '商家风采', 'ADI02', '', '2014-11-17 15:59:32', '/shop/', NULL, 3, 0, 0, '2049-12-12 12:12:12', 0, NULL, NULL),
...
(32, '1518229779ad77', '文字', '', '产品中心', 'ADI02', '', '2018-02-10 10:29:39', '/product/', NULL, 0, 0, 0, '2049-09-09 09:09:09', 0, NULL, NULL),
(33, '1518229816ad98', '文字', '', '手机版', 'ADI02', '', '2018-02-10 10:30:16', '/mt/', NULL, 4, 0, 0, '2049-09-09 09:09:09', 0, NULL, NULL);
...
(4, 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', '管理员', ',0,');
...
INSERT INTO `yjcode_control` (`id`, `weburlv`, `webnamev`, `webtit`, `webkey`, `webdes`, `webtj`, `dbsj`, `ycsj`, `tksj`, `webtelv`, `webqqv`, `selltc`, `regmoney`, `pjjf`, `zftype`, `partner`, `security_code`, `seller_email`, `ifsell`, `openshop`, `ifproduct`, `mailname`, `mailsmtp`, `mailpwd`, `maildk`, `tenpay1`, `tenpay2`, `qqappid`, `qqappkey`, `ifmob`, `smsfun`, `ifkf`, `beian`, `websyposv`, `qdjf`, `propx`, `regjf`, `jfmoney`, `tjmoney`, `bankbh`, `bankkey`, `taskok`, `sellbl`, `smskc`, `sermode`, `ipsshh`, `ipszs`, `txdi`, `txfl`, `nowmb`, `shoprz`, `inittj`, `fhxs`, `wxpay`, `yunpay`, `ifuc`, `ifci`, `ci`, `txyh`, `wxpayfs`, `smsmode`, `taskyj`, `ifwap`, `iftask`, `otherpay`, `taskoksj`, `taskerrsj`, `openbao`, `wxlogin`, `regmob`, `sxjf`) VALUES
(1, 'http://localhost/', '友价商城源码', '友价商城源码_官网地址 http://www.yj99.cn', '友价源码,友价商城,友价T5商城,虚拟商品交易网站,源码交易平台', '', '', 3, 7, 5, '0577-67068160', '2403653050*购买源码,2468437512*源码咨询,3320003537*订制开发', 0.7, 0, 20, 0, '', '', '', 'off', 100, 'off', '', 'ssl://smtp.exmail.qq.com', '', '465', '', '', '', '', 'on', '', 'on', 'ICP证：浙B1-008008', 9, 5, 0, 0, 100, 0, '', '', 0, 1, 0, 0, '', '', 0, 0, 'default', 'xcf', '0,0,0,0', '1,2,3,4,5,', ',,,', NULL, 0, 0, '', '支付宝xcf微信xcf工商银行xcf农业银行xcf建设银行xcf中国银行xcf', 0, 2, 0, 0, 0, '', 15, 15, 0, ',', 0, 10);
...
(1, '000', '验证码：${yzm},如果不是本人操作，请忽略此信息。', ''),
(2, '001', '验证码：${yzm},您正在找回密码，如果不是本人操作，请忽略此信息。', ''),
(3, '002', '验证码：${yzm},您正在进行手机解除绑定，如果不是本人操作，请忽略此信息。', ''),
(4, '003', '验证码：${yzm},您正在进行手机绑定，如果不是本人操作，请忽略此信息。', ''),
(5, '004', '亲，有新订单啦！请尽快登录网站发货，购买商品为：${tit}', ''),
(6, '005', '退款通知：有买家进行了退款，商品单价${money1}元，数量${num}，请尽快登录网站处理', ''),
(7, '006', '验证码：${yzm},您正在通过手机验证直接登录，如果不是本人操作，请忽略此信息。', ''),
(8, '007', '您的工单状态已经变更为：${zttz}', '');
...
(1, '1518229684d27', '普通会员', 1, '2018-02-10 10:28:14', 10, 0, 0, 1);
