...
<div class="yjcode">
  ...
  <li class="l4"><input name="C1" type="checkbox" checked value="1"><a href="../help/aboutview1.html" target="_blank">我已阅读并接受<?=webname?>会员注册协议</a></li>
  <li class="l3">
  ...
  <li class="l3">
  <? 
  while1("*","yjcode_user where zt=1 and shopzt=2 and pm>0 order by pm asc limit 12");while($row1=mysqli_fetch_array($res1)){
