...
<ul>
<a class="bond_info" target="_blank" href="http://www.huzhan.com/protection/">
...
$d = explode(',',$rowss[control_keywords]);
$e = rand(0,count($d));
$f = $d[$e];


if($row[pro_keywords]){
$pro_keywords = "<a href='http://a8zhan.com' target='_blank'>".$row[pro_keywords]."</a>";
}else{
$pro_keywords = "<a href='http://a8zhan.com' target='_blank'>".$f."</a>";
}

echo $row[txt].$pro_keywords;
