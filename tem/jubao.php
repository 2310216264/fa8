...
if($admin==1){
 while0("*","yjcode_pro where id=".$id);if(!$row=mysqli_fetch_array($res)){Audit_alert("来源错误！",weburl,"parent.");}
 $tit=$row[tit];
}
...
<div class="jubao fontyh">
 ...
 <? while1("*","yjcode_jubaotype where admin=".$admin." and zt=0 order by xh asc");while($row1=mysqli_fetch_array($res1)){?>
