...
if($_GET[control]=="login"){
 ...
 while0("*","yjcode_user where (uid='".$uid."' or (mot='".$uid."' and ifmot=1)) and pwd='".sha1($pwd)."'");if(!$row=mysqli_fetch_array($res)){php_toheader("openw.php?t=err");}
...
function mianonc(x){
 ...
 document.getElementById("miancap2").className="a1 a11";
 document.getElementById("miancap1").style.display="none";
 return false;
 }
 for(i=1;i<=2;i++){
...
<body>
  ...
  <div class="tccap">
  <a href="javascript:void(0);" class="a1" id="miancap1" onclick="mianonc(1)">账号登录/注册</a>
  <a href="javascript:void(0);" id="miancap2" onclick="mianonc(2)">免登录操作</a>
  </div>
  
  <div class="yjcode" id="mianv1">
  <div class="loginleft">
  ...
  <div class="yjcode" id="mianv2" style="display:none;">
