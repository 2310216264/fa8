...
parent.ptype4.location="about:blank";
parent.ptype5.location="about:blank";
...
<body>
 ...
 <!--begin-->
  ...
  <a href="javascript:void(0);" class="a1"><?=$type1name?> <img border="0" src="../img/jiandown.gif" width="7" height="4" /></a>
   <? while2("*","yjcode_type where admin=2 and type1='".$type1name."' order by xh asc");while($row2=mysqli_fetch_array($res2)){?>
