...
<div class="yjcode">
 ...
 <div class="myright">
  ...
  <? 
  while1("*","yjcode_news where zt=0 and userid=".$rowuser[id]." order by lastsj desc limit 10");while($row1=mysqli_fetch_array($res1)){
  ...
  <? 
  while1("*","yjcode_propj where userid=".$rowuser[id]." order by sj desc limit 10");while($row1=mysqli_fetch_array($res1)){
  while2("*","yjcode_pro where bh='".$row1[probh]."'");$row2=mysqli_fetch_array($res2);
  ?>
  ...
  <? 
  while1("*","yjcode_newspj where zt=0 and userid=".$rowuser[id]." order by sj desc limit 10");while($row1=mysqli_fetch_array($res1)){
  while2("*","yjcode_news where bh='".$row1[newsbh]."'");$row2=mysqli_fetch_array($res2);
  ?>
