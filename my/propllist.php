...
<div class="yjcode">
 ...
 <div class="myright">
  ...
  <ul class="u3">
  <? 
  pagef(" where userid=".$rowuser[id]."",20,"yjcode_propj","order by sj desc");while($row=mysqli_fetch_array($res)){
  while2("*","yjcode_pro where bh='".$row[probh]."'");$row2=mysqli_fetch_array($res2);
  ?>
