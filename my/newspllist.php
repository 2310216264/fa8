...
<div class="yjcode">
 ...
 <div class="myright">
  ...
  <ul class="u2">
  <? 
  pagef(" where zt=0 and userid=".$rowuser[id]."",20,"yjcode_newspj","order by sj desc");while($row=mysqli_fetch_array($res)){
  while2("*","yjcode_news where bh='".$row[newsbh]."'");$row2=mysqli_fetch_array($res2);
  ?>
