...
<div class="yjcode">
 ...
 <li class="l3">
 <? while1("*","yjcode_protype where admin=1 and zt=0 and userid=".$rowuser[id]." order by xh asc");while($row1=mysqli_fetch_array($res1)){?>
 ...
 <li class="l3">
 <? while1("*","yjcode_protype where admin=2 and name1='".$name1."' and zt=0 and userid=".$rowuser[id]." order by xh asc");while($row1=mysqli_fetch_array($res1)){?>
