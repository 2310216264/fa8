...
<div class="right">
 ...
 <li class="l2">
 <a href="<?=$nu?>"><strong><?=$row1[type1]?></strong></a><? if(empty($row1[iftj])){?> <span class="red">(推荐)</span><? }?>
 </li>
 ...
 <li class="l8">
 <a href="typelists.php?ty1id=<?=$row1[id]?>">二级列表</a>
 <span></span><a href="typesxlist.php?typeid=<?=$row1[id]?>">附加选项</a>
 </li>
 </ul>
 <? }?>
 <!--end-->
