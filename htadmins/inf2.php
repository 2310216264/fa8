...
if(sqlzhuru($_POST[jvs])=="control"){
 ...
 if(intval($_POST[Rsmsmode])==1 || intval($_POST[Rsmsmode])==2){}else{
  while1("*","yjcode_control");$row1=mysqli_fetch_array($res1);
...
<div class="right">
 ...
 while1("*","yjcode_smsmb where mybh='".$nbh."'");if($row1=mysqli_fetch_array($res1)){$mbid=$row1[mbid];$txt=$row[txt];}else{
