...
AdminSes_audit();
$id=$_GET[id];
while0("*","yjcode_tixian where id=".$id);if(!$row=mysqli_fetch_array($res)){php_toheader("txlist.php");}
...
<div class="right">
 ...
 <li class="l1">会员信息：</li>
 <li class="l2">
 <? while1("uid,nc","yjcode_user where id=".$row[userid]);$row1=mysqli_fetch_array($res1);?>
