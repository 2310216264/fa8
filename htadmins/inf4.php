...
if(sqlzhuru($_POST[jvs])=="control"){
 ...
 updatetable("yjcode_control",$ses."
			  ...
			  serversellbl=".sqlzhuru($_POST[tserversellbl])."
			  ");
...
<div class="right">
 ...
 if($row1=mysqli_fetch_array($res1)){$d=$row1[daynum];$jf=$row1[jf];}else{$d="";$jf="";}
 ?>
 <ul class="yue">
 ...
 <li class="l1">卖家商品收入：</li>
 <li class="l2">
 <input name="tsellbl" value="<?=$row[sellbl]?>" size="10" type="text" class="inp" />
 <span class="fd">商品交易后，卖家可获得的金额比例:1表示全归卖家，0.9表示90%归卖家。<span class="red">(如果商品分组有设置，以商品分组设置为准)</span></span>
 </li>
 ...
 <li class="l1">卖家服务收入：</li>
 <li class="l2">
 <input name="tserversellbl" value="<?=$row[serversellbl]?>" size="10" type="text" class="inp" />
 <span class="fd">服务交易后，卖家可获得的金额比例:1表示全归卖家，0.9表示90%归卖家。</span>
 </li>
