...
<input type="hidden" value="youhui_add" name="youhui_type" />

<ul class="uk">
<li class="l1"><span class="red">*</span> 优惠等级：</li>
<li class="l2">

<input type="text" value="" class="inp" size="20" name="das" />
...
<li class="l2"><input type="text" value="" class="inp" size="5" name="zhekou" /> <span class="fd">如10表示无折扣，9表示9折，依次类推，0表示免费</span></li>
