...
AdminSes_audit();
while0("*","yjcode_soft_type where id='".$_GET[id]."' and level=2");if(!$row=mysqli_fetch_array($res,MYSQLI_ASSOC)){}
?>
...
<input type="hidden" name="soft_type" value="soft_sedit">
<input type="hidden" name="id" value="<?=$row[id]?>" />
<ul class="uk">
<li class="l1"><span class="red">*</span> 子类名称：</li>
<li class="l2"><input type="text" value="<?=$row[soft_type_name]?>" class="inp"  name="soft_type_name"/></li>

<li class="l1"><span class="red">*</span> SEO关键词：</li>
<li class="l2"><input type="text" value="<?=$row[soft_seokey]?>" class="inp inpw" name="soft_seokey" /></li>

<li class="l1"><span class="red">*</span> SEO描述：</li>
