...
<div class="right">
 ...
 <?
 while1("*","yjcode_helptype where admin=1 order by xh asc");while($row1=mysqli_fetch_array($res1)){
 ...
 <?
 while2("*","yjcode_helptype where admin=2 and name1='".$row1[name1]."' order by xh asc");while($row2=mysqli_fetch_array($res2)){
