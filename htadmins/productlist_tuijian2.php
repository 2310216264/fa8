...
<div class="right">
	<div class="bqu1">
		<a href="productlist_tuijian.php">首页推荐</a>
		<a class="a1" href="productlist_tuijian2.php" id="rtit1">产品页推荐</a>
	</div>
	
	<ul class="ksedi">
		<li class="l2">
			<a href="javascript:void(0);" class="a1" onclick="weizhi(2);">新增位置</a>
		</li>
	</ul>
	...
	<? while1("id,bianhao,price,sorts,state,add_time,pro_default","yjcode_tuijian where type=2 order by id desc limit 10");while($row1=mysqli_fetch_array($res1)){?>
