...
if($_GET[control]=="update"){
 if(!strstr($adminqx,",0,") && !strstr($adminqx,",0101,")){Audit_alert("权限不够","default.php","parent.");}
 zwzr();
 if(panduan("*","yjcode_servertaocan where admin=1 and serverbh='".$bh."' and zt<>99 and tit1='".sqlzhuru($_POST[t1])."' and id<>".$id)==1){Audit_alert("该套餐内容已存在！","servertaocan1.php?action=update&id=".$id."&bh=".$bh);}
...
<body style="overflow-x:hidden;">
 ...
 <? if($_GET[t]=="suc"){systs("恭喜您，操作成功！[<a href='servertaocan1lx.php?bh=".$bh."'>继续添加新套餐</a>]","servertaocanlist.php?bh=".$bh);}?>
 ...
 <li class="l1">套餐图标：</li>
 <li class="l2"><input type="file" name="inp2" class="inp1" id="inp2" size="15" accept=".jpg,.gif,.jpeg,.png"><span class="fd">最佳尺寸：254*167,不上传则显示文字形式</span></li>
