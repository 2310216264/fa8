...
$sj=date("Y-m-d H:i:s");
$bh=$_GET[bh];
while0("*","yjcode_userdj where bh='".$bh."'");if(!$row=mysqli_fetch_array($res)){php_toheader("userdjlist.php");}
...
<div class="right">
 ...
 <li class="l2"><input type="text" value="<?=$row[zhekou]?>" class="inp" size="5" name="tzhekou" /> <span class="fd">如10表示无折扣，9表示9折，依次类推，0表示免费</span></li>
 <li class="l1"><span class="red">*</span> 等级费用：</li>
 <li class="l2">
 <input type="text" value="<?=$row[money1]?>" class="inp" size="20" name="tmoney1" />
 ...
 <option value="9"<? if(9==$row[jgdw]){?> selected="selected"<? }?>>终身</option>
 </select>
 <span class="fd red">只有设置终身会员(永久会员)时，才选择终身</span>
 </li>
