...
while1("*","yjcode_taocan where id=".$ty1id);if(!$row1=mysqli_fetch_array($res1)){php_toheader("productlist.php");}
...
php_toheader("taocan1.php?ty1id=".intval($_GET[ty1id])."&bh=".$bh."&id=".$id);
?>
