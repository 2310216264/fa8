...
$sj=date("Y-m-d H:i:s");
while0("*","yjcode_task where taskty=1 and bh='".$bh."'");if(!$row=mysqli_fetch_array($res)){php_toheader("tasklist1.php");}
?>
...
<div class="right">
 ...
 <div class="gdhflist">
  ...
  <? 
  while1("*","yjcode_tasklog where bh='".$bh."' and useridhf=".$useridhf." order by sj asc");while($row1=mysqli_fetch_array($res1)){
  $txt=$row1[txt];
