...
AdminSes_audit();
while0("*","yjcode_soft_type where id='".$_GET[id]."'");if(!$row=mysqli_fetch_array($res,MYSQLI_ASSOC)){}
?>
...
<input type="hidden" name="soft_type" value="soft_sadd">
<input type="hidden" name="fid" value="<?=$row[id]?>" />
<ul class="uk">
<li class="l1"><span class="red">*</span> 父类名称：</li>
<li class="l2"><input type="text" value="<?=$row[soft_type_name]?>" class="inp redony" readonly/></li>

<li class="l1"><span class="red">*</span> 子类名称：</li>
<li class="l2"><input type="text" value="" class="inp"  name="soft_type_name"/></li>

<li class="l1"><span class="red">*</span> 关键词：</li>
<li class="l2"><input type="text" value="" class="inp inpw" name="soft_seokey" /></li>

<li class="l1"><span class="red">*</span> 描述：</li>
<li class="l8"><textarea class="tseodes inpw" name="soft_seodes"></textarea></li>

<li class="l1"><span class="red">*</span> 排序：</li>
<li class="l2"><input type="text" class="inp" name="sorts" value=""/></li>
