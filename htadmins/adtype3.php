...
<div class="right">
 ...
 <?
 $adbh=array("ADN00","ADNV01","ADNV02","ADNV03","ADNV04","ADNV05","ADNV06","ADNV07");
 $adtit=array("资讯首页切换","资讯正文页右侧广告","资讯详情页最新发布上方横幅","资讯详情页摘要上方横幅","资讯列表页右侧广告","资讯首页横幅","资讯列表页横幅","资讯详情页横幅");
 $adsize=array("850*380","290*?","828*?","828*?","290*?","1150*?","1150*?","1150*?");
 $admust=array("pic","","","","","","","");
