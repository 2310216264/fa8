...
.provcap .l2{width:-moz-calc(100% - 531px);width:-webkit-calc(100% - 531px);width:calc(100% - 531px);text-align:left;padding-left:10px;}
.provcap .l3{width:100px;}
.provcap .l4{width:80px;}
.provcap .l5{width:200px;}
.provcap .l6{width:100px;}
...
.provlist .l2{width:-moz-calc(100% - 531px);width:-webkit-calc(100% - 531px);width:calc(100% - 531px);text-align:left;padding-left:10px;}
.provlist .l3{width:100px;}
.provlist .l4{width:80px;}
.provlist .l5{width:200px;}
.provlist .l6{width:100px;color:#999;}
.provlist .l6 a{color:#333;}
...
<body>
 ...
 <?
 pagef($ses,10,"yjcode_provideo","order by sj desc");while($row=mysqli_fetch_array($res)){
 ...
 <li class="l6"><a href="<?=$aurl?>">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="../video/index.php?id=<?=$row[id]?>" target="_blank">预览</a></li>
 </ul>
 <? }?>
 <?
