...
AdminSes_audit();
while0("*","yjcode_tuijian where id='".$_GET[id]."'");if(!$row=mysqli_fetch_array($res)){}
?>
...
<input type="hidden" value="weizhi_default" name="weizhi_type" />
<input type="hidden" name="id" value="<?=$row[id]?>">

<ul class="uk">
<li class="l1">默认产品编码：</li>
<li class="l2"><input type="text" class="inp" name="pro_default" value="<?=$row[pro_default]?>" />
</ul>
