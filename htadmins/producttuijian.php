...
AdminSes_audit();
$sj=date("Y-m-d H:i:s");
$ses=" where zt=0 and ifxj=0 and iftj>0";
...
<div class="right">
 ...
 <?
 pagef($ses,20,"yjcode_pro","order by lastsj desc");while($row=mysqli_fetch_array($res)){
 ...
 <li class="l4"><?=$row[kcnum]?><? if(4==$row[fhxs]){?><br>【<a href="javascript:void(0);" onclick="taocankconc('<?=$row[bh]?>')" class="blue">管理库存</a>】<? }?></li>
