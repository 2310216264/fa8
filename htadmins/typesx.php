...
if($_GET[control]=="add"){
 ...
 move_uploaded_file($_FILES["inp1"]['tmp_name'], "../tem/moban/".$rowcontrol[nowmb]."/homeimg/".$rowcontrol[nowmb]."Img/typesx1_".$id.".png");
...
<div class="right">
 ...
 <? if($_GET[t]=="suc"){systs("恭喜您，操作成功！【<a href='typesx.php?typeid=".$typeid."'>继续添加</a>】","typesx.php?action=".$_GET[action]."&id=".$_GET[id]."&typeid=".$_GET[typeid]);}?>
 <div class="bqu1">
 ...
 $id=intval($_GET[id]);
 while0("*","yjcode_typesx where id=".$id);if(!$row=mysqli_fetch_array($res)){php_toheader("typesxlist.php?typeid=".$typeid);}
 ?>
 <script language="javascript">
 function tj(){
 ...
 <li class="l1">图标：</li>
 <li class="l2"><input type="file" class="inp1" name="inp1" id="inp1" size="15" accept=".jpg,.gif,.jpeg,.png"><span class="fd">根据实际情况上传(每套模板都是独立的)</span></li>
 <? $ntp="../tem/moban/".$rowcontrol[nowmb]."/homeimg/".$rowcontrol[nowmb]."Img/typesx1_".$row[id].".png";if(is_file($ntp)){?>
 <li class="l8"></li>
