...
while0("*","yjcode_newstype where id=".$_GET[ty1id]);$row=mysqli_fetch_array($res);
...
<div class="right">
 ...
 while1("*","yjcode_newstype where id=".$_GET[id]);if(!$row1=mysqli_fetch_array($res1)){php_toheader("newstypelist.php");}
 ?>
 <script language="javascript">
 function tj(){
 if((document.f1.t1.value).replace(/\s/,"")==""){alert("请输入资讯分类名称！");document.f1.t1.focus();return false;}
